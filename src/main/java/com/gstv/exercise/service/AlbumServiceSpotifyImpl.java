...
public class AlbumServiceSpotifyImpl implements AlbumService {
    ...
    private List<Album> getAlbumsByArtist(Artist artist) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        AlbumSearch search = restTemplate.getForObject(Constants.SPOTIFY_BASE_URL + "/artists/"+ artist.getId() +"/albums?album_type=album&market=US&limit10", AlbumSearch.class);
